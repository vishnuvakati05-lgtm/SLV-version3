...
import { FiSmartphone, FiDownload, FiCheckCircle, FiWifi, FiPackage, FiStar, FiBell } from 'react-icons/fi';
import { FaAndroid } from 'react-icons/fa';
import { Link } from 'react-router-dom';

const features = [
  { icon: FiPackage, text: 'Full Product Catalog' },
  { icon: FiStar, text: 'Exclusive Offers & Deals' },
  { icon: FiBell, text: 'Real-time Order Updates' },
  { icon: FiWifi, text: 'Works Offline Too' },
  { icon: FiDownload, text: 'Easy Document Downloads' },
  { icon: FiCheckCircle, text: 'Direct WhatsApp Inquiry' },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
              ...
              <div className="pt-8 pb-4 px-3 bg-gradient-to-b from-[#023047] to-[#0077B6]/60 min-h-[420px] sm:min-h-[520px]">
                ...
                <div className="flex items-center gap-2 px-2 py-3 mb-3">
                  <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#0077B6] to-[#00B4D8] flex items-center justify-center">
                    <span className="text-white font-black text-[9px]">SL</span>
                  </div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold text-slate-700 dark:text-white">Android 5.0+</span>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-1.5">
                <FiStar className="text-[#023047] w-3.5 h-3.5 fill-current" />
                <span className="text-[10px] font-extrabold text-[#023047]">4.9 Rating</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="mt-3 text-[11px] text-slate-400 dark:text-slate-600 flex items-center gap-1.5">
            ...
            Free download · No subscription required · Android 5.0+
          </p>
        </motion.div>
      </div>
    </div>
